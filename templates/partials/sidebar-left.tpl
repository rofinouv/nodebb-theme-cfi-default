<nav component="sidebar/left" class="{{{ if config.theme.openSidebars}}}open{{{ end }}} text-dark bg-light sidebar sidebar-left start-0 vh-100 d-none d-lg-flex flex-column justify-content-between sticky-top" style="background:#001231!important;color:#ffb222!important">
